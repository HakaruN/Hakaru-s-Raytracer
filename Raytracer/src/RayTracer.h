...
public:
	...
	static void Render(int bufferWidth, int widthStart, int widthEnd, int heighStart, int heightEnd, float* frameBuffer, float &t, Sphere &lighting, std::vector<Sphere> &spheres);
	static void runRayTracer(int width, int height, float* cpuFrameBuffer, float t, Sphere &lighting, std::vector<Sphere> &spheres);
