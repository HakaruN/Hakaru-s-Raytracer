...
{		
	public:
		...
		inline static void Render(int bufferWidth, int bufferHeight, int widthStart, int widthEnd, int heightStart, int heightEnd, int coloursPerPixel, bool perspective, bool isCheckerboarding, bool depthRender, float* frameBuffer, Camera& camera, Colour& background, Sphere &lighting, std::vector<Renderable*>* renderables);
